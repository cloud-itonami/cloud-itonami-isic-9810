# Operator Quickstart — Undifferentiated goods-producing activities of private households for own use

Shortest path from clone to a verified local dry-run for **ISIC 9810** (`cloud-itonami-isic-9810`).
...
```bash
git clone https://github.com/cloud-itonami/cloud-itonami-isic-9810.git
cd cloud-itonami-isic-9810
```
...
- Blueprint governor key: `hhproduction-governor`
- Likely source path: `hhproductionops.governor.cljc`
